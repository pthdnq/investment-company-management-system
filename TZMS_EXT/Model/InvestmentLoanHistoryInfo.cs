//----------------------------------------------------------------------------------------------------
//程序名:	InvestmentLoanHistory实体类
//功能:   定义了与 dbo.InvestmentLoanHistory 表 对应的数据实体类
//作者:  	CodeSmith
//时间:	2010-10-25 
//----------------------------------------------------------------------------------------------------
//更改历史:
...
{
    /// <summary>
    /// InvestmentLoanHistory实体类
    /// </summary>
    [Serializable]
    public class InvestmentLoanHistoryInfo : ACommonInfo
    {
        ...
        /// Constructor
        /// </summary>
        public InvestmentLoanHistoryInfo()
        {
            //todo
        }
        #endregion
