//----------------------------------------------------------------------------------------------------
//程序名:	FinancingFeePaymentHistory实体类
//功能:   定义了与 dbo.FinancingFeePaymentHistory 表 对应的数据实体类
//作者:  	CodeSmith
//时间:	2010-10-25 
//----------------------------------------------------------------------------------------------------
//更改历史:
...
{
    /// <summary>
    /// FinancingFeePaymentHistory实体类
    /// </summary>
    [Serializable]
    public class FinancingFeePaymentHistoryInfo : ACommonInfo
    {
        ...
        /// Constructor
        /// </summary>
        public FinancingFeePaymentHistoryInfo()
        {
            //todo
        }
        #endregion
