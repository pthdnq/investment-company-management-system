...
namespace com.TZMS.Business
{
    public class BankLoanManage : ParentManage
    {
        ...
        {
            List<BankLoanInfo> users = ctrl.SelectAsList(boName, "  ObjectID ='" + objectID + "' ");
            if (users.Count == 0)
            {
                return null;
            }
        ...
        {
            List<BankLoanInfo> users = ctrl.SelectAsList(boName, "   AccountNo ='" + accountNo + "' ");
            if (users.Count == 0)
            {
                return null;
            }
        ...
        {
            List<BankLoanProjectProcessInfo> users = rctrl.SelectAsList(boName, "  ObjectID ='" + objectID + "' ");
            if (users.Count == 0)
            {
                return null;
            }
