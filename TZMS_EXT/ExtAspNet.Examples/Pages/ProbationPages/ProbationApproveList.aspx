<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProbationApproveList.aspx.cs"
    Inherits="TZMS.Web.ProbationApproveList" %>
...
<body>
                ...
                <Items>
                    <ext:Grid ID="gridApprove" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:BoundField DataField="Result" HeaderText="审批结果" />
    ...
    <ext:Window ID="wndApprove" Title="转正审批" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
