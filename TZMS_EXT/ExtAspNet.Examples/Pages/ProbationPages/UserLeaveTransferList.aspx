<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLeaveTransferList.aspx.cs" Inherits="TZMS.Web.UserLeaveTransferList" %>
...
<ext:PageManager ID="PageManager1" AutoSizePanelID="pelMain" HideScrollbar="true"
                ...
                <Rows>
                    <ext:FormRow ID="FormRow1" runat="server">
                        <Items>
                            ...
                            <ext:DropDownList ID="ddlstAproveState" runat="server" Label="交接状态">
                                <ext:ListItem Text="全部" Value="3" />
                                <ext:ListItem Text="待交接" Value="0" Selected="true" />
                                <ext:ListItem Text="已交接" Value="1" />
                            </ext:DropDownList>
    ...
    <ext:Window ID="wndTransfer" Title="离职交接" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
