<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentAuditTransfer.aspx.cs" Inherits="TZMS.Web.Pages.FolkFinancingPages.PaymentAuditTransfer" %>
        ...
        <Items>
            ...
            <ext:TabStrip ID="TabStrip1" runat="server" ActiveTabIndex="0" ShowBorder="false"
                ...
                <Tabs>
                    ...
                    <ext:FormRow ColumnWidths="50% 50%">
                        <Items>
                            <ext:TextBox ID="tbAmountOfPayment" Label="支付金额" Enabled="false" runat="server" MaxLength="16"
