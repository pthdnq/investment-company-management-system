<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentAuditList.aspx.cs"
    Inherits="TZMS.Web.Pages.FolkFinancingPages.PaymentAuditList" %>
...
<body>
                    ...
                    <ext:Grid ID="gridData" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:BoundField ExpandUnusedSpace="true" DataTooltipField="PaymentAccount" DataField="PaymentAccount"
                                HeaderText="付款帐号" />
                            <ext:BoundField Width="150px" DataTooltipField="ReceivablesAccount" DataField="ReceivablesAccount"
                                HeaderText="收款帐号" />
                            <ext:BoundField Width="115px" DataField="AmountOfPaymentEx" HeaderText="支付金额" />
    ...
    <ext:Window ID="wndNew" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
        Target="Parent" runat="server" IsModal="true" Height="386px" Width="550px" OnClose="wndNew_Close">
    </ext:Window>
    </form>
</body>
</html>
