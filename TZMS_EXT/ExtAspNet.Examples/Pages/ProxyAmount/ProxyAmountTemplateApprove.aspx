<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProxyAmountTemplateApprove.aspx.cs"
    Inherits="TZMS.Web.ProxyAmountTemplateApprove" %>
                                    ...
                                    <ext:Form EnableBackgroundColor="true" LabelWidth="55px" ShowHeader="false" ShowBorder="false"
                                        ...
                                        <Rows>
                                            <ext:FormRow ID="FormRow3" runat="server" ColumnWidths="50%">
                                                <Items>
                                                    <ext:Label ID="lblProxyAmountType" Label="费用类型" runat="server">
                                                    </ext:Label>
                                                </Items>
                                            </ext:FormRow>
                                            ...
                                            <ext:FormRow ID="FormRow8" runat="server" ColumnWidths="60%">
                                                <Items>
                                                    <ext:Label ID="lblSument" runat="server" Label="收款事由" Hidden="true">
                                                    </ext:Label>
                                                </Items>
                                            </ext:FormRow>
                                            <ext:FormRow ID="FormRow10" runat="server">
                                                <Items>
                                                    ...
                                                    <ext:Label ID="lblOpeningDate" runat="server" Label="开票日期" Hidden="true">
                                                    </ext:Label>
                                                </Items>
                                            </ext:FormRow>
