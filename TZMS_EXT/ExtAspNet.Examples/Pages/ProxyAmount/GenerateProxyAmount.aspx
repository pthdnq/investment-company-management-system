            ...
            <ext:Panel ID="pelGrid" ShowBorder="True" ShowHeader="false" AnchorValue="100% -60"
                ...
                <Toolbars>
                    <ext:Toolbar ID="toolApp" runat="server">
                        <Items>
                            <ext:Button ID="btnGenerateDZ" Text="代账费生成" ToolTip="代账费生成" Icon="Add" runat="server"
                            ...
                            <ext:Label ID="Label2" runat="server" Text="代账费">
                            </ext:Label>
                ...
                <Items>
                    <ext:Grid ID="gridProxyAmount" Title="Grid1" ShowBorder="true" ShowHeader="false"
                        ...
                        <Columns>
                            ...
                            <ext:BoundField DataField="State" HeaderText="代账单状态" />
