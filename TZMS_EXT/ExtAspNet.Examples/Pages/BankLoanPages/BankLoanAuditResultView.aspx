                                ...
                                <Rows>
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            ...
                                            <ext:TextBox ID="tbLoanCompany" runat="server" Enabled="false" Label="贷款公司" MaxLength="20" MaxLengthMessage="最多只能输入20个字符！">
                                            </ext:TextBox>
                                        </Items>
                                    </ext:FormRow>
                                    <ext:FormRow ColumnWidths="50% 50%">
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            ...
                                            <ext:TextBox ID="tbDownPayment" Enabled="false" Label="预付订金" runat="server" MaxLength="16"
                                                MaxLengthMessage="最多只能输入16位！" Regex="^\-?[0-9]*\.?[0-9]{1,2}$"  RegexMessage="金额格式不正确!">
                                            </ext:TextBox>
                                        </Items>
                                    </ext:FormRow>
