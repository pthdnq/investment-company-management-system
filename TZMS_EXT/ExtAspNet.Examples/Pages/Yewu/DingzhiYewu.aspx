<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DingzhiYewu.aspx.cs" Inherits="TZMS.Web.DingzhiYewu" %>
...
<body>
            ...
            <ext:Panel ID="pelGrid" ShowBorder="True" ShowHeader="false" AnchorValue="100% -36"
                ...
                <Toolbars>
                    <ext:Toolbar ID="toolApp" runat="server">
                        <Items>
                            <ext:Button ID="btnNewYewu" Text="新建定制业务" ToolTip="新建定制业务" Icon="Add" runat="server">
                            </ext:Button>
                        </Items>
                    </ext:Toolbar>
                </Toolbars>
    ...
    <ext:Window ID="wndNewYewu" Title="新建定制业务" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
