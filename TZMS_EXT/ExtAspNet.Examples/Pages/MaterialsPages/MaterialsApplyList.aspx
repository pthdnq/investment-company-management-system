<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialsApplyList.aspx.cs"
    Inherits="TZMS.Web.MaterialsApplyList" %>
                ...
                <Items>
                    <ext:Grid ID="gridApply" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:LinkButtonField Width="38px" Text="删除" ConfirmTarget="Parent" ConfirmText="确定删除该物资申请单?" />
                        </Columns>
                    </ext:Grid>
                </Items>
            </ext:Panel>
