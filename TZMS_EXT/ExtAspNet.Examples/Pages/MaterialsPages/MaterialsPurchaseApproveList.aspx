<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialsPurchaseApproveList.aspx.cs"
    Inherits="TZMS.Web.MaterialsPurchaseApproveList" %>
...
<body>
                ...
                <Items>
                    <ext:Grid ID="gridApprove" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:BoundField DataField="Count" HeaderText="数量" />
                            <ext:BoundField DataField="Money" HeaderText="金额" />
                            <ext:BoundField DataField="NeedsDate" HeaderText="需要日期" />
                            <ext:BoundField DataField="Sument" ExpandUnusedSpace="true" HeaderText="申请事由" DataTooltipField="Sument" />
    ...
    <ext:Window ID="wndMaterialsPurchaseApprove" Title="物资采购审批" Popup="false" EnableIFrame="true"
        IFrameUrl="about:blank" Target="Parent" runat="server" IsModal="true" EnableConfirmOnClose="true"
        Height="500px" Width="700px" onclose="wndMaterialsPurchaseApprove_Close">
    </ext:Window>
    </form>
</body>
</html>
