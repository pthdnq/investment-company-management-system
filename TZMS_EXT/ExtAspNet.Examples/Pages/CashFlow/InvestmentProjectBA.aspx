<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvestmentProjectBA.aspx.cs"
    Inherits="TZMS.Web.Pages.CashFlow.InvestmentProjectBA" %>

<%@ Register Src="~/CommonControls/MudFlexCtrl.ascx" TagName="MudFlexCtrl" TagPrefix="ucl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>InvestmentProjectBA</title>
                        ...
                        <Items>
                            <ext:Form EnableBackgroundColor="true" LabelWidth="50px" ShowHeader="false" ShowBorder="false"
                                ...
                                <Rows>
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextBox Enabled="false" ID="tbCustomerName" Label="客户名称" ShowRedStar="true"
                                                Hidden="true" Required="true" runat="server" MaxLength="20" MaxLengthMessage="最多只能输入20个字符！">
                                            </ext:TextBox>
                                        </Items>
                                    </ext:FormRow>
                                    <ext:FormRow ColumnWidths="50% 50%">
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:DatePicker Enabled="false" Hidden="true" ID="dpSignDate" Label="签订日期" ShowRedStar="true"
