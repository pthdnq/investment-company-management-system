<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FolkFinancingBA.aspx.cs"
    Inherits="TZMS.Web.Pages.CashFlow.FolkFinancingBA" %>

<%@ Register Src="~/CommonControls/MudFlexCtrl.ascx" TagName="MudFlexCtrl" TagPrefix="ucl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>FolkFinancingBA</title>
                                ...
                                <Rows>
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            ...
                                            <ext:TextBox Enabled="false" ID="tbLenders" Label="出款人" runat="server" Hidden="true"
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextBox Enabled="false" ID="tbGuarantee" Label="担保人" runat="server" Hidden="true"
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextBox Enabled="false" ID="tbLoanAmount" Label="借款金额" runat="server" Hidden="true"
                                                MaxLength="16" MaxLengthMessage="最多只能输入16个数字！" Regex="^[0-9]*$" RegexMessage="只能输入数字!">
                                            </ext:TextBox>
                                        </Items>
                                    </ext:FormRow>
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:DatePicker Enabled="false" Hidden="true" ID="dpLoanDate" Label="借款日期" runat="server">
                                            </ext:DatePicker>
                                            <ext:TextBox Enabled="false" Hidden="true" ID="dpDueDateForPay" Label="应付款日" runat="server"
                                                MaxLength="2" MaxLengthMessage="最多只能输入2个数字！" Regex="[1-3][0-9]*$" RegexMessage="只能输入数字!"
                                                Text="1">
                                            </ext:TextBox>
                                        </Items>
                                    </ext:FormRow>
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextBox Enabled="false" Hidden="true" ID="tbCollateral" Label="抵押物" runat="server"
                                                MaxLength="20" MaxLengthMessage="最多只能输入20个字符！">
                                            </ext:TextBox>
                                        </Items>
                                    </ext:FormRow>
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextBox Enabled="false" ID="tbBorrowingCost" Label="借款成本" Hidden="true" runat="server"
                                                MaxLength="8" MaxLengthMessage="最多只能输入16个数字！"  Regex="^[0-9]*\.?[0-9]{1,2}$" RegexMessage="只能输入数字!">
                                            </ext:TextBox>
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextBox Enabled="false" ID="tbContactPhone" Label="联系电话" runat="server" MaxLength="20"
                                                MaxLengthMessage="最多只能输入20个字符！" Hidden="true" Regex="(\(?\d{3,4}\)?)?[\s-]?\d{7,8}[\s-]?\d{0,4}"
