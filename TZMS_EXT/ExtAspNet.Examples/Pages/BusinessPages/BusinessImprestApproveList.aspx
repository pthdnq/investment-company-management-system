<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BusinessImprestApproveList.aspx.cs"
    Inherits="TZMS.Web.BusinessImprestApproveList" %>
...
<body>
    ...
    <ext:Panel ID="pelMain" runat="server" EnableBackgroundColor="true" BodyPadding="3px"
        ...
        <Items>
            <ext:Form ID="Form2" ShowBorder="False" LabelWidth="55px" BodyPadding="5px" AnchorValue="100%"
                ...
                <Rows>
                    <ext:FormRow ID="FormRow1" runat="server">
                        <Items>
                            <ext:TextBox ID="tbxSearch" runat="server" EmptyText="请输入申请人姓名查询" ShowLabel="false">
                            </ext:TextBox>
            ...
            <ext:Panel ID="pelGrid" ShowBorder="True" ShowHeader="false" AnchorValue="100% -60"
                ...
                <Items>
                    <ext:Grid ID="gridBusinessImprestApprove" Title="Grid1" ShowBorder="true" ShowHeader="false"
                        AllowPaging="true" runat="server" IsDatabasePaging="true" EnableRowNumber="True"
                        AutoHeight="true" OnPageIndexChange="gridBusinessImprestApprove_PageIndexChange"
                        OnRowCommand="gridBusinessImprestApprove_RowCommand" OnRowDataBound="gridBusinessImprestApprove_RowDataBound">
                        <Columns>
                            ...
                            <ext:BoundField DataField="BusinessName" HeaderText="项目标题" DataTooltipField="BusinessName" />
                            <ext:BoundField DataField="SumMoney" HeaderText="金额(元)" />
                            <ext:BoundField DataField="Sument" HeaderText="申请事由" DataTooltipField="Sument" ExpandUnusedSpace="true" />
    ...
    <ext:Window ID="wndBusinessImprestApprove" Title="备用金审批" Popup="false" EnableIFrame="true"
        IFrameUrl="about:blank" Target="Parent" runat="server" IsModal="true" EnableConfirmOnClose="true"
        Height="500px" Width="700px" OnClose="wndBusinessImprestApprove_Close">
    </ext:Window>
    </form>
</body>
</html>
