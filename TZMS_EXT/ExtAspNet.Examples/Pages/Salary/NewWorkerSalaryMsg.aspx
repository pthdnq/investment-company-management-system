                        ...
                        <Rows>
                            ...
                            <ext:FormRow ID="FormRow2" runat="server" ColumnWidths="50% 50%">
                                <Items>
                                    ...
                                    <ext:Button ID="btnChooseUser" runat="server" Text="选取员工..." 
                                        OnClick="btnChooseUser_Click">
                                    </ext:Button>
                                </Items>
                            </ext:FormRow>
                            <ext:FormRow ID="FormRow3" runat="server" ColumnWidths="50% 50%">
                                <Items>
                                    <ext:TextBox ID="tbxBaseSalary" Label="基本工资" runat="server" Required="true" ShowRedStar="true"
                                        Regex="^[0-9]*\.?[0-9]{1,2}$" RegexMessage="金额格式不正确!" Text="0.0">
                                    </ext:TextBox>
                            ...
                            <ext:FormRow ID="FormRow6" runat="server" ColumnWidths="50% 50%">
                                <Items>
                                    <ext:TextArea ID="taaContext" runat="server" Label="备注" EmptyText="请输入备注信息" Height="100px" MaxLength="100" MaxLengthMessage="最多只能输入100个字符!">
                                    </ext:TextArea>
                                </Items>
                            </ext:FormRow>
                        </Rows>
