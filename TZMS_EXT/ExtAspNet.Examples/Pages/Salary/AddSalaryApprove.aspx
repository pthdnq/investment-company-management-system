<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSalaryApprove.aspx.cs"
    Inherits="TZMS.Web.AddSalaryApprove" %>
                    ...
                    <ext:Form ID="mainForm2" EnableBackgroundColor="true" ShowHeader="false" BodyPadding="5px"
                        ...
                        <Rows>
                            ...
                            <ext:FormRow ID="FormRow1" runat="server" ColumnWidths="50% 50%">
                                <Items>
                                    <ext:TextBox ID="tbxOtherSalary" runat="server" Label="实际加薪幅度" Regex="^[0-9]*\.?[0-9]{1,2}$"
                                        ...
                                        <Rows>
                                            ...
                                            <ext:FormRow ID="FormRow4" runat="server" ColumnWidths="60%">
                                                <Items>
                                                    ...
                                                    <ext:Label ID="lblExamSalary" runat="server" Label="申请加薪幅度">
                                                    </ext:Label>
                                                </Items>
                                            </ext:FormRow>
                                            <ext:FormRow ID="FormRow5" runat="server" ColumnWidths="60%">
                                                <Items>
                                                    <ext:TextArea ID="taaReason" runat="server" Label="加薪原因" Enabled="false" Height="200px">
                                                    </ext:TextArea>
                                                </Items>
                                            </ext:FormRow>
                                        </Rows>
