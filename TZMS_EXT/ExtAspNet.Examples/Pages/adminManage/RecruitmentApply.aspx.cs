...
namespace TZMS.Web
{
    public partial class RecruitmentApply : BasePage
    {
        /// <summary>
        /// 操作类型
        /// </summary>
        ...
        private void SaveApply()
        {
            if (OperatorType == null)
                return;
            RecruitmentApplyInfo _applyInfo = null;
            ...
            if (OperatorType == "Add")
            {
                ...
                _applyInfo = new RecruitmentApplyInfo();
                ...
                _applyInfo.Content = taaContent.Text.Trim();
                _applyInfo.State = 0;
                ...
                // 插入起草记录到代帐费审批流程表.
                RecruitmentApproveInfo _approveInfo = new RecruitmentApproveInfo();
                ...
                // 插入待审批记录到报销审批流程表.
                _approveInfo = new RecruitmentApproveInfo();
        ...
        {
            RecruitmentManage _manage = new RecruitmentManage();
            RecruitmentApplyInfo _info = _manage.GetApplyByObjectID(ApplyID);
            if (_info != null)
            {
                ...
                // 查找最早的审批记录.
                List<RecruitmentApproveInfo> lstApprove = _manage.GetApproveByCondition(" ApplyID = '" + ApplyID + "' and ApproveOp <> 0");
                ...
                {
                    lstApprove.Sort(delegate(RecruitmentApproveInfo x, RecruitmentApproveInfo y) { return DateTime.Compare(x.ApproveTime, y.ApproveTime); });
        ...
        private void BindApproveHistory()
        {
            ...
            List<RecruitmentApproveInfo> lstBaoxiaoCheckInfo = new RecruitmentManage().GetApproveByCondition(strCondition.ToString());

            lstBaoxiaoCheckInfo.Sort(delegate(RecruitmentApproveInfo x, RecruitmentApproveInfo y) { return DateTime.Compare(y.ApproveTime, x.ApproveTime); });
