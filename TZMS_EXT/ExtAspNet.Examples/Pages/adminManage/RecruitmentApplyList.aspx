<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecruitmentApplyList.aspx.cs" Inherits="TZMS.Web.RecruitmentApplyList" %>
...
<body>
            ...
            <ext:Panel ID="pelGrid" ShowBorder="True" ShowHeader="false" AnchorValue="100% -36"
                ...
                <Toolbars>
                    <ext:Toolbar ID="toolApp" runat="server">
                        <Items>
                            <ext:Button ID="btnNewApply" Text="招聘申请" ToolTip="招聘申请" Icon="Add" runat="server">
                            </ext:Button>
                        </Items>
                    </ext:Toolbar>
                </Toolbars>
                <Items>
                    <ext:Grid ID="gridApply" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:BoundField DataField="Content" HeaderText="内容" DataTooltipField="Content"
    ...
    <ext:Window ID="wndNewApply" Title="招聘申请" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
