    ...
    public partial class JingShengApprove : BasePage
    {
        ...
        protected void btnPass_Click(object sender, EventArgs e)
        {
            ...
            if (result == -1)
            {
                ...
                {
                    ResultMsgMore(ddlstApproveUser.SelectedValue.ToString(), ddlstApproveUser.SelectedText, "晋升调岗中，您有1条 待归档 信息！");
                    ResultMsgMore(_applyInfo.UserID.ToString(), _applyInfo.Name, "您有1条晋升调岗申请（来自行政管理），已通过审核,待归档！");
                }
