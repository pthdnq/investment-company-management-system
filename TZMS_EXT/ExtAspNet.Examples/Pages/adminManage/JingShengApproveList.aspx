<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JingShengApproveList.aspx.cs"
    Inherits="TZMS.Web.JingShengApproveList" %>
...
<body>
                ...
                <Items>
                    <ext:Grid ID="gridApprove" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:BoundField DataField="Context" HeaderText="晋升调岗原因" DataTooltipField="Context"
    ...
    <ext:Window ID="wndApprove" Title="晋升调岗申请审批" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
