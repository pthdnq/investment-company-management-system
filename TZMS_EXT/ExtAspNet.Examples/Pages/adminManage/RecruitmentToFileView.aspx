<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecruitmentToFileView.aspx.cs"
    Inherits="TZMS.Web.RecruitmentToFileView" %>
                                    ...
                                    <ext:Form ID="Form2" EnableBackgroundColor="true" ShowHeader="false" BodyPadding="5px"
                                        ...
                                        <Rows>
                                            ...
                                            <ext:FormRow ID="FormRow4" runat="server" ColumnWidths="60%">
                                                <Items>
                                                    <ext:TextArea ID="taaContent" runat="server" Label="内容" Height="250px" Enabled="false">
                                                    </ext:TextArea>
                                                </Items>
                                            </ext:FormRow>
                                        </Rows>
