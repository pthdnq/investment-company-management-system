...
namespace TZMS.Web
{
    public partial class BaoXiaoPinZhengApproveList : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                CurrentLevel = GetCurrentLevel("bxpzsp");
        ...
        private void BindGrid()
        {
            ...
            strCondition.Append(" and (ApproveTime between '" + startTime.ToString("yyyy-MM-dd 00:00") + "' and '" 
                + endTime.ToString("yyyy-MM-dd 23:59") 
            ...
            _comHelp.TableName = "BaoXiaoPinZhengView";
            _comHelp.SelectList = "*";
        ...
        protected void gridApprove_RowCommand(object sender, ExtAspNet.GridCommandEventArgs e)
        {
            ...
            {
                wndApprove.IFrameUrl = "BaoXiaoPinZhengApprove.aspx?ApproveID=" + strApproveID + "&ApplyID=" + strApplyID;
