<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EndingContractAuditList.aspx.cs" Inherits="TZMS.Web.Pages.InvestmentLoanPages.EndingContractAuditList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>EndingContractAuditList</title>
</head>
<body>
                ...
                <Items>
                    <ext:Grid ID="gridData" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:WindowField Width="38px" Text="审核" DataIFrameUrlFields="ObjectId" DataIFrameUrlFormatString="EndingContractAudit.aspx?ID={0}"
