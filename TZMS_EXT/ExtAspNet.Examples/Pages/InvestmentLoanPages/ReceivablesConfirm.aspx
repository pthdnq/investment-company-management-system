            ...
            <ext:Toolbar ID="Toolbar1" runat="server">
                <Items>
                    ...
                    <ext:Button ID="btnSave" runat="server" ValidateForms="mainFrame" OnClick="btnSave_Click"
                        IconUrl="~/Images/ico_nextstep.gif" Text="收款确认" ConfirmText="您确认该收款信息吗?" />
                            ...
                            <ext:Form EnableBackgroundColor="true" ShowHeader="false" BodyPadding="5px" ID="mainFrame"
                                ...
                                <Rows>
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextArea ID="taAuditOpinionRemark" Label="收款备注" runat="server" MaxLength="200"
                                                ShowRedStar="true" Required="true" MaxLengthMessage="最多只能输入200个字符！" />
                                        </Items>
                                    </ext:FormRow>
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextBox Enabled="false" ID="tbProjectName" Label="项目名称" runat="server" MaxLength="20"
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextBox Enabled="false" ID="tbAmountofpaidUp" Label="实收金额"   runat="server" MaxLength="16" MaxLengthMessage="最多只能输入16个数字！"
                                                 Regex="^[0-9]*\.?[0-9]{1,2}$" RegexMessage="只能输入数字!">
                                            </ext:TextBox>
                                        </Items>
                                    </ext:FormRow>
