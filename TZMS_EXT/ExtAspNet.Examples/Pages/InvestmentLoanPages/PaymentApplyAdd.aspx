        ...
        <Toolbars>
            <ext:Toolbar ID="Toolbar1" runat="server">
                <Items>
                    ...
                    <ext:Label Text="" ID="LbTooltip" runat="server" CssStyle="Color:Red;">
                    </ext:Label>
                </Items>
            </ext:Toolbar>
        </Toolbars>
                    ...
                    <ext:FormRow ColumnWidths="50% 50%">
                        <Items>
                            <ext:TextBox ID="tbLoanAmount" Label="借款金额(元)" Text="0.00" ShowRedStar="true" Required="true"
                                ...
                                MaxLengthMessage="最多只能输入16个数字！"   Regex="^[0-9]*\.?[0-9]{1,2}$" RegexMessage="金额格式不正确!"  CompareControl="tbCash"
                    ...
                    <ext:FormRow ColumnWidths="50% 50%">
                        <Items>
                            ...
                            <ext:TextBox ID="tbRateOfReturn" Label="投资回报率(%)" runat="server" ShowRedStar="true"
                                Required="true"  MaxLengthMessage="最多只能输入10个数字！" MaxLength="10"  Regex="^[0-9]*\.?[0-9]{1,2}$"
                                RegexMessage="只能输入数字!" />
                        </Items>
                    </ext:FormRow>
                    <ext:FormRow ColumnWidths="50% 50%">
