<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectProcessList.aspx.cs"
    Inherits="TZMS.Web.Pages.InvestmentProjectPages.ProjectProcessList" %>
                ...
                <Items>
                    <ext:Grid ID="gridData" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:WindowField Width="38px" Text="审核" DataIFrameUrlFields="ObjectId" DataIFrameUrlFormatString="ProjectProcessAdult.aspx?Type=Edit&ID={0}"
                                Title="审核" WindowID="wndNew" />
                            <ext:LinkButtonField Hidden="true" Width="38px" Text="删除" ConfirmText="确定删除该记录?"
                                CommandName="Delete" />
                            <ext:WindowField Width="38px" Text="查看" DataIFrameUrlFields="ObjectId" DataIFrameUrlFormatString="ProjectProcessAdult.aspx?Type=View&ID={0}"
