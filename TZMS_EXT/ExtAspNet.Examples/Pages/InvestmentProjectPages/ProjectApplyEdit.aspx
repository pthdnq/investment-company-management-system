<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectApplyEdit.aspx.cs" Inherits="TZMS.Web.Pages.InvestmentProjectPages.ProjectApplyEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ProjectApplyEdit</title>
</head>
<body>
        ...
        <Toolbars>
            <ext:Toolbar ID="Toolbar1" runat="server">
                <Items>
                    ...
                    <ext:Button ID="btnDismissed" Hidden="true"  runat="server" ValidateForms="pelMain" OnClick="btnDismissed_Click"
                ...
                <Rows>
                    ...
                    <ext:FormRow ColumnWidths="100%">
                        <Items>
                          ...
                          Enabled="false"   CssClass="gray"   Regex="^[a-zA-Z0-9\u4e00-\u9fa5]*$" RegexMessage="不能输入特殊字符!">
                            </ext:TextArea>
                        </Items>
                    </ext:FormRow>
                </Rows>
                ...
                <Tabs>
                    ...
                    <ext:FormRow ColumnWidths="50% 50%">
                        <Items>
                            ...
                            <ext:TextBox ID="tbContactPhone" Label="联系人电话" runat="server" MaxLength="20" MaxLengthMessage="最多只能输入20个字符！"
                    ...
                    <ext:FormRow ColumnWidths="50% 50%">
                        <Items>
                            <ext:TextBox ID="tbContractAmount" Label="合同总金额" runat="server" MaxLength="8" MaxLengthMessage="最多只能输入8位数字！"
                                Regex="^[0-9]*$" RegexMessage="只能输入数字!" ShowRedStar="true" Required="true">
                            </ext:TextBox>
                            <ext:TextBox ID="tbDownPayment" Label="预付定金" runat="server" MaxLength="8" MaxLengthMessage="最多只能输入8位数字！"
                                Regex="^[0-9]*$" RegexMessage="只能输入数字!" ShowRedStar="true" Required="true">
                            </ext:TextBox>
                        </Items>
                    </ext:FormRow>
                                    <ext:FormRow ColumnWidths="100%">
                                        <Items>
                                            <ext:TextArea Enabled="false" ID="tbRemark" Label="备注" runat="server" MaxLength="200"
