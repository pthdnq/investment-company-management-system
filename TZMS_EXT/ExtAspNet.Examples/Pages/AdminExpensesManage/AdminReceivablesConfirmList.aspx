<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminReceivablesConfirmList.aspx.cs" Inherits="TZMS.Web.Pages.AdminExpensesManage.AdminReceivablesConfirmList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>AdminReceivablesConfirmList</title>
</head>
<body>
                ...
                <Items>
                    <ext:Grid ID="gridData" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                     ...
                     <ext:BoundField Width="85px" DataField="Company" HeaderText="单位" />
                            ...
                            <ext:BoundField Width="70px" DataField="AmountOfReceivablesEx" DataTooltipField="AmountOfReceivablesEx"
                                HeaderText="金额" />
                            ...
                            <ext:WindowField Width="38px" Text="查看" DataIFrameUrlFields="ObjectId" DataIFrameUrlFormatString="AdminReceivablesConfirm.aspx?Type=View&ID={0}"
                                Title="查看" WindowID="wndView" />
                            <ext:WindowField Width="38px" Text="确认" DataIFrameUrlFields="ObjectId" DataIFrameUrlFormatString="AdminReceivablesConfirm.aspx?Type=Confirm&ID={0}"
