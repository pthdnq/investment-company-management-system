<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminReceivablesConfirmPrinter.aspx.cs"
    Inherits="TZMS.Web.Pages.AdminExpensesManage.AdminReceivablesConfirmPrinter" %>
...
<body>
    ...
    <div style="width: 800px;">
        ...
        <h5>
            申请时间：  <asp:Label runat="server" ID="lbLoanDate"></asp:Label></h5>
        <table class="jxtable" border="1" cellpadding="10" cellspacing="0">
      <tr>
                <td colspan="2">
                    项目： <asp:Label runat="server" ID="tbProjectName"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    事由：<asp:Label runat="server" ID="lbImplementationPhase"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="2">
