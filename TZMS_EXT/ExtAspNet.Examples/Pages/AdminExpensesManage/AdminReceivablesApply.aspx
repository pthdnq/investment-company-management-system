<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminReceivablesApply.aspx.cs"
    Inherits="TZMS.Web.Pages.AdminExpensesManage.AdminReceivablesApply" %>
                                ...
                                <Rows>
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            ...
                                            <ext:TextBox ID="tbAmountOfReceivables" Label="金额" ShowRedStar="true" Required="true"
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextArea ID="taCause" Label="收款事由" runat="server" ShowRedStar="true" Required="true"
                                                MaxLength="200" MaxLengthMessage="最多只能输入200个字符！">
                                            </ext:TextArea>
                                        </Items>
                                    </ext:FormRow>
