<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPaymentAuditList.aspx.cs"
    Inherits="TZMS.Web.Pages.AdminExpensesManage.AdminPaymentAuditList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>AdminPaymentAuditList</title>
</head>
<body>
                ...
                <Items>
                    <ext:Grid ID="gridData" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:BoundField Width="70px" DataField="AmountOfPaymentEx" DataTooltipField="AmountOfPaymentEx"
                                HeaderText="金额" />
                            ...
                            <ext:WindowField Width="38px" Text="查看" DataIFrameUrlFields="ObjectId" DataIFrameUrlFormatString="AdminPaymentAudit.aspx?Type=View&ID={0}"
                                Title="查看" WindowID="wndView" />
                            <ext:WindowField Width="38px" Text="审核" DataIFrameUrlFields="ObjectId" DataIFrameUrlFormatString="AdminPaymentAudit.aspx?Type=Audit&ID={0}"
    ...
    <ext:Window ID="wndView" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
        Target="Parent" runat="server" IsModal="true" Height="390px" Width="550px" OnClose="wndNew_Close">
    </ext:Window>
    <ext:Window ID="wndEdit" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
        Target="Parent" runat="server" IsModal="true" Height="460px" Width="550px" OnClose="wndNew_Close">
    </ext:Window>
    </form>
</body>
</html>
