<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminImprestConfirmList.aspx.cs" Inherits="TZMS.Web.Pages.AdminExpensesManage.AdminImprestConfirmList" %>
                ...
                <Items>
                    <ext:Grid ID="gridData" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:WindowField Width="38px" Text="查看" DataIFrameUrlFields="ObjectId" DataIFrameUrlFormatString="AdminImprestConfirm.aspx?Type=View&ID={0}"
                                Title="查看" WindowID="wndView" />
                            <ext:WindowField Width="38px" Text="确认" DataIFrameUrlFields="ObjectId" DataIFrameUrlFormatString="AdminImprestConfirm.aspx?Type=Confirm&ID={0}"
...
<%--    <ext:Window ID="wndNew" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
    ...
    <ext:Window ID="wndView" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
        Target="Parent" runat="server" IsModal="true" Height="313px" Width="550px" OnClose="wndNew_Close">
    </ext:Window>
    <ext:Window ID="wndEdit" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
        Target="Parent" runat="server" IsModal="true" Height="378px" Width="550px" OnClose="wndNew_Close">
    </ext:Window>
    </form>
</body>
</html>
