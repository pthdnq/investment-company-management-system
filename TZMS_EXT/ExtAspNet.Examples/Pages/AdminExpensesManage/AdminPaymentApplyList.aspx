<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPaymentApplyList.aspx.cs"
    Inherits="TZMS.Web.Pages.AdminExpensesManage.AdminPaymentApplyList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>AdminPaymentApplyList</title>
</head>
<body>
                ...
                <Items>
                    <ext:Grid ID="gridData" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:WindowField Width="38px" Text="编辑" DataIFrameUrlFields="ObjectId" DataIFrameUrlFormatString="AdminPaymentApply.aspx?Type=Edit&ID={0}"
    ...
    <ext:Window ID="wndNew" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
        Target="Parent" runat="server" IsModal="true" Height="395px" Width="550px" OnClose="wndNew_Close">
    </ext:Window>
