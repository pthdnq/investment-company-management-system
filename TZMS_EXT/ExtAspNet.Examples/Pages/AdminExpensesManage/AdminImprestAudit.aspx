<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminImprestAudit.aspx.cs"
    Inherits="TZMS.Web.Pages.AdminExpensesManage.AdminImprestAudit" %>
                        ...
                        <Items>
                            <ext:Form EnableBackgroundColor="true" LabelWidth="63px" ShowHeader="false" ShowBorder="false"
                                ...
                                <Rows>
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextBox ID="tbPrepaidAmount" Enabled="false" Label="预支金额" runat="server" MaxLength="16"
                                                MaxLengthMessage="最多只能输入16位！"  Regex="^\-?[0-9]*\.?[0-9]{1,2}$"   RegexMessage="只能输入数字或-!">
                                            </ext:TextBox>
                                        </Items>
                                    </ext:FormRow>
                                    <ext:FormRow ColumnWidths="50% 50%">
