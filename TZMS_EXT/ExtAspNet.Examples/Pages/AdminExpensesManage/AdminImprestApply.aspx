<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminImprestApply.aspx.cs"
    Inherits="TZMS.Web.Pages.AdminExpensesManage.AdminImprestApply" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>AdminImprestApply</title>
</head>
<body>
            ...
            <ext:Form EnableBackgroundColor="true" ShowHeader="false" BodyPadding="5px" ID="mainFrame"
                ...
                <Rows>
                    ...
                    <%--              <ext:FormRow ColumnWidths="50% 50%">
                        <Items>
                            <ext:TextArea ID="taAuditOpinion" Label="审核意见" Hidden="true" runat="server" MaxLength="200"
                        ...
                        <Items>
                            <ext:Form EnableBackgroundColor="true" LabelWidth="63px" ShowHeader="false" ShowBorder="false"
                                ...
                                <Rows>
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextArea ID="taUse" Label="用途" runat="server" MaxLength="200" MaxLengthMessage="最多只能输入200个字符！"  ShowRedStar="true" Required="true">
                                            </ext:TextArea>
                                        </Items>
                                    </ext:FormRow>
