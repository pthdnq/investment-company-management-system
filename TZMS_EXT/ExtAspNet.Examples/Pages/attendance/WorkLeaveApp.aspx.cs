    ...
    public partial class WorkLeaveApp : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //请假申请 新增按钮
                wndLeaveApp.Title = "调休申请";
                btnNewApp.OnClientClick = wndLeaveApp.GetShowReference("WorkLeaveAppNew.aspx?Type=Add") + "return false;";
        ...
        protected void gridLeave_RowCommand(object sender, ExtAspNet.GridCommandEventArgs e)
        {
            ...
            {
                wndLeaveApp.IFrameUrl = "WorkLeaveAppNew.aspx?Type=View&LeaveID=" + strLeaveID;
                wndLeaveApp.Hidden = false;
            }

            if (e.CommandName == "Edit")
            {
                wndLeaveApp.IFrameUrl = "WorkLeaveAppNew.aspx?Type=Edit&LeaveID=" + strLeaveID;
                wndLeaveApp.Hidden = false;
            }
