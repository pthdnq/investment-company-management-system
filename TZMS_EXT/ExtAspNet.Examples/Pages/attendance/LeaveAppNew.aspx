        ...
        <Toolbars>
            <ext:Toolbar runat="server">
                <Items>
                    ...
                    <ext:Button ID="btnSave" OnClick="btnSave_Click" runat="server" Icon="Disk" Text="提交" ConfirmText="您确定提交该表单吗?"
                                ...
                                <Items>
                                    <ext:Form EnableBackgroundColor="true" ShowHeader="false" ShowBorder="false" BodyPadding="5px"
                                        ...
                                        <Rows>
                                            ...
                                            <ext:FormRow runat="server" ColumnWidths="50% 50%">
                                                <Items>
                                                    ...
                                                    <ext:TextBox ID="txtHours" ShowRedStar="true" MaxLength="5" MaxLengthMessage="最多只能输入5个字！"
                                                        Required="true" EmptyText="单位：小时" runat="server" Label="请假时长" Regex="^[0-9]*$" RegexMessage="只能输入数字!">
                                                    </ext:TextBox>
                                                </Items>
                                            </ext:FormRow>
