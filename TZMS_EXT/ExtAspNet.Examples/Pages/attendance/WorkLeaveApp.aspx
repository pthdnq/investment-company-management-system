<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkLeaveApp.aspx.cs" Inherits="TZMS.Web.WorkLeaveApp" %>
...
<form id="form1" runat="server">
                    ...
                    <ext:FormRow>
                        <Items>
                            <ext:DropDownList ID="ddlappState" runat="server" Label="申请状态">
                                ...
                                <ext:ListItem Text="归档-未通过" Value="3" />
                            </ext:DropDownList>
            ...
            <ext:Panel ID="pelGrid" ShowBorder="True" ShowHeader="false" AnchorValue="100% -36"
                ...
                <Toolbars>
                    <ext:Toolbar ID="toolApp" runat="server">
                        <Items>
                            <ext:Button ID="btnNewApp" Text="调休申请" ToolTip="调休申请" Icon="Add" runat="server">
                            </ext:Button>
                        </Items>
                    </ext:Toolbar>
                </Toolbars>
                <Items>
                    <ext:Grid ID="gridLeave" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:LinkButtonField Width="38px" Text="删除" ConfirmTarget="Parent" ConfirmText="确定删除该调休申请单?"
    ...
    <ext:Window ID="wndLeaveApp" Title="调休申请" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
