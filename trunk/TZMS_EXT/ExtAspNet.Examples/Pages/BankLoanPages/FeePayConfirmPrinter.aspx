<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeePayConfirmPrinter.aspx.cs"
    Inherits="TZMS.Web.Pages.BankLoanPages.FeePayConfirmPrinter" %>
...
<body>
    ...
    <div style="width: 800px;">
        ...
        <h5>
            申请时间：
            <asp:Label runat="server" ID="tbDate"></asp:Label></h5>
        <table class="jxtable" border="1" cellpadding="10" cellspacing="0">
            ...
            <tr>
                <td colspan="2">
                    借款用途：
                    <asp:Label runat="server" ID="taImplementationPhase"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                    （小写）：<asp:Label runat="server" ID="tbAmountExpended"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="2">
