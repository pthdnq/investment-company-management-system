<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BankLoanAuditTransfer.aspx.cs" Inherits="TZMS.Web.Pages.BankLoanPages.BankLoanAuditTransfer" %>
        ...
        <Toolbars>
            <ext:Toolbar ID="Toolbar1" runat="server">
                <Items>
                    ...
                    <ext:Button Hidden="true" ID="btnDismissed" runat="server" ValidateForms="mainFrame" OnClick="btnDismissed_Click"
                        IconUrl="~/Images/ico_nextstep.gif" Text="业务移交" ConfirmText="您确定将该业务移交吗?" />
                    ...
                    <ext:FormRow ColumnWidths="50% 50%">
                        <Items>
                            <ext:TextArea ID="taAuditOpinion" Label="操作备注" ShowRedStar="true" Required="true"
                                runat="server" MaxLength="200" MaxLengthMessage="最多只能输入20个字符！" />
                        </Items>
                    </ext:FormRow>
                </Rows>
            </ext:Form>
            <ext:TabStrip ID="TabStrip1" runat="server" ActiveTabIndex="0" ShowBorder="false"
                AutoHeight="true" Height="422px">
                <Tabs>
                                ...
                                <Rows>
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            ...
                                            <ext:TextBox ID="tbDownPayment" Enabled="false" Label="预付定金" runat="server" MaxLength="16"
                                                MaxLengthMessage="最多只能输入16位！" Regex="^\-?[0-9]*\.?[0-9]{1,2}$"  RegexMessage="金额格式不正确!">
                                            </ext:TextBox>
                                        </Items>
                                    </ext:FormRow>
