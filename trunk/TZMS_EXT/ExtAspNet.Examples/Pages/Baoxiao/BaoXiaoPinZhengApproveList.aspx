<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BaoXiaoPinZhengApproveList.aspx.cs"
    Inherits="TZMS.Web.BaoXiaoPinZhengApproveList" %>
            ...
            <ext:Form ID="Form2" ShowBorder="False" LabelWidth="55px" BodyPadding="5px" AnchorValue="100%"
                ...
                <Rows>
                    <ext:FormRow ID="FormRow1" runat="server">
                        <Items>
                            <ext:TextBox ID="tbxSearch" runat="server" EmptyText="请输入凭证标题查询" ShowLabel="false">
                            </ext:TextBox>
