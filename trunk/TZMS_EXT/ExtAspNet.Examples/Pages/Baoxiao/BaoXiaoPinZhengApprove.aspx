<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BaoXiaoPinZhengApprove.aspx.cs"
    Inherits="TZMS.Web.BaoXiaoPinZhengApprove" %>
                    ...
                    <ext:TabStrip ID="TabStrip1" runat="server" ActiveTabIndex="0" ShowBorder="false"
                        ...
                        <Tabs>
                            <ext:Tab ID="Tab1" Title="报销凭证" EnableBackgroundColor="true" runat="server" BodyPadding="5px">
                                <Items>
                                    <ext:Form EnableBackgroundColor="true" LabelWidth="55px" ShowHeader="false" ShowBorder="true"
                                        BodyPadding="5px" ID="mainForm" runat="server">
                                        <Rows>
                                            <ext:FormRow ID="FormRow111" runat="server" ColumnWidths="50% 50%">
                                                <Items>
                                            ...
                                            <ext:FormRow ID="FormRow5" runat="server" ColumnWidths="60%">
                                                <Items>
                                                    <ext:Label ID="tbxTitle" runat="server" Label="标题">
                                                    </ext:Label>
                                                </Items>
                                            </ext:FormRow>
                                            <ext:FormRow ID="FormRow1" runat="server" ColumnWidths="60%">
                                                <Items>
                                                    <ext:TextArea ID="taaReport" Height="200px" runat="server" Label="报表数据" Enabled="false">
                                                    </ext:TextArea>
                                                </Items>
                                            </ext:FormRow>
                                        </Rows>
                                ...
                                <Items>
                                    <ext:Form EnableBackgroundColor="true" LabelWidth="65px" ShowHeader="false" ShowBorder="true"
                                        ...
                                        <Rows>
                                            ...
                                            <ext:FormRow ID="FormRow31" runat="server" ColumnWidths="60%">
                                                <Items>
                                ...
                                <Items>
                                    <ext:Grid ID="gridApproveHistory" Title="Grid1" ShowBorder="true" ShowHeader="false"
                                        ...
                                        <Columns>
                                            ...
                                            <ext:BoundField DataField="ApproveSugest" HeaderText="执行人意见" DataTooltipField="ApproveSugest" ExpandUnusedSpace="true" />
                                        </Columns>
                                    </ext:Grid>
                                </Items>
                            </ext:Tab>
