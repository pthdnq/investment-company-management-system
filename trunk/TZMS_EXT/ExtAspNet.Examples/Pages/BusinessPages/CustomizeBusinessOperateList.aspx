<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomizeBusinessOperateList.aspx.cs" Inherits="TZMS.Web.CustomizeBusinessOperateList" %>
...
<ext:PageManager ID="PageManager1" AutoSizePanelID="pelMain" HideScrollbar="true"
    ...
    <ext:Window ID="wndCustomizeBusinessTransfer" Title="定制业务转移" Popup="false" EnableIFrame="true"
        IFrameUrl="about:blank" Target="Parent" runat="server" IsModal="true" EnableConfirmOnClose="true"
        Height="580px" Width="700px" onclose="wndCustomizeBusinessTransfer_Close">
    </ext:Window>
    </form>
</body>
</html>
