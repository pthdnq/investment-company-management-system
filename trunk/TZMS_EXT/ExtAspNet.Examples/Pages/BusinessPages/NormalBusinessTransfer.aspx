<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NormalBusinessTransfer.aspx.cs"
    Inherits="TZMS.Web.NormalBusinessTransfer" %>
                                ...
                                <Items>
                                    <ext:Form EnableBackgroundColor="true" LabelWidth="90px" ShowHeader="false" ShowBorder="false"
                                        ...
                                        <Rows>
                                            ...
                                            <ext:FormRow ColumnWidths="50% 50%">
                                                <Items>
                                                    <ext:TextBox ID="tbxRegisteredMoney" runat="server" MaxLengthMessage="最多只能输入16位"  MaxLength="16" Label="注册资金" Regex="^\-?[0-9]*\.?[0-9]{1,2}$" 
