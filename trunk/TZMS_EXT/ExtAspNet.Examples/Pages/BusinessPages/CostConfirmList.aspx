<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostConfirmList.aspx.cs" Inherits="TZMS.Web.CostConfirmList" %>
    ...
    <ext:Panel ID="pelMain" runat="server" EnableBackgroundColor="true" BodyPadding="3px"
        ...
        <Items>
            ...
            <ext:Panel ID="pelGrid" ShowBorder="True" ShowHeader="false" AnchorValue="100% -36"
                ...
                <Items>
                    <ext:Grid ID="gridCostConfirm" Title="Grid1" ShowBorder="true" 
                        ShowHeader="false" AllowPaging="true"
                        runat="server" IsDatabasePaging="true" EnableRowNumber="True" 
                        AutoHeight="true" OnPageIndexChange="gridCostConfirm_PageIndexChange" 
                        OnRowCommand="gridCostConfirm_RowCommand" 
