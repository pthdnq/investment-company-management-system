<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BusinessImprestApplyList.aspx.cs"
    Inherits="TZMS.Web.BusinessImprestApplyList" %>
            ...
            <ext:Panel ID="pelGrid" ShowBorder="True" ShowHeader="false" AnchorValue="100% -60"
                ...
                <Toolbars>
                    <ext:Toolbar ID="toolApp" runat="server">
                        <Items>
                            <ext:Button ID="btnNewBusinessImprestApply" Text="备用金申请" ToolTip="备用金申请" Icon="Add"
                                runat="server">
                            </ext:Button>
                        </Items>
                    </ext:Toolbar>
                ...
                <Items>
                    <ext:Grid ID="gridBusinessImprestApply" Title="Grid1" ShowBorder="true" ShowHeader="false"
                        AllowPaging="true" runat="server" IsDatabasePaging="true" EnableRowNumber="True"
                        AutoHeight="true" OnPageIndexChange="gridBusinessImprestApply_PageIndexChange"
                        OnRowCommand="gridBusinessImprestApply_RowCommand" OnRowDataBound="gridBusinessImprestApply_RowDataBound">
                        <Columns>
                            <ext:BoundField DataField="ObjectID" Hidden="true" />
                            <ext:BoundField DataField="BusinessID" Hidden="true" />
                            <ext:BoundField DataField="ApplyTime" HeaderText="申请时间" />
                            <ext:BoundField DataField="BusinessName" HeaderText="公司名称" DataTooltipField="BusinessName" />
