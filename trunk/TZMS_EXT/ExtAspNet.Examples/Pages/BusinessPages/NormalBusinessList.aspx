<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NormalBusinessList.aspx.cs"
    Inherits="TZMS.Web.NormalBusinessList" %>
            ...
            <ext:Panel ID="pelGrid" ShowBorder="True" ShowHeader="false" AnchorValue="100% -60"
                ...
                <Toolbars>
                    <ext:Toolbar ID="toolApp" runat="server">
                        <Items>
                            <ext:Button ID="btnNewNormalBusiness" Text="新增普通业务" ToolTip="新增普通业务" Icon="Add" runat="server">
                            </ext:Button>
                        </Items>
                    </ext:Toolbar>
                </Toolbars>
