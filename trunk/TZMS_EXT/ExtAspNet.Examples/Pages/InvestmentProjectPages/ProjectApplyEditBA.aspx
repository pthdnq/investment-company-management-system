<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectApplyEditBA.aspx.cs" Inherits="TZMS.Web.Pages.InvestmentProjectPages.ProjectApplyEditBA" %>
                ...
                <Rows>
                    <ext:FormRow ID="FormRow2" runat="server" ColumnWidths="50% 50%">
                      ...
                      <ext:FormRow ColumnWidths="100%">
                        <Items> 
                            <ext:TextArea    ID="tbRemark" Label="备注" runat="server" MaxLength="200"  MaxLengthMessage="最多只能输入200个字符！"></ext:TextArea>
                        </Items>
                    </ext:FormRow>
                    <ext:FormRow ColumnWidths="100%">
                        <Items>
                            <ext:TextArea ID="tbAuditOpinion"  Enabled="false"  Label="审核意见" runat="server" MaxLength="200" MaxLengthMessage="最多只能输入200个字符！"
