<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectApplyEdit.aspx.cs"
    Inherits="TZMS.Web.Pages.InvestmentProjectPages.ProjectApplyEdit" %>
                    ...
                    <ext:FormRow ColumnWidths="100%">
                        <Items>
                            <ext:TextArea ID="tbAuditOpinion" Label="审核意见" runat="server" MaxLength="200" MaxLengthMessage="最多只能输入200个字符！"
                                Hidden="true" Enabled="false" CssClass="gray" Regex="^[a-zA-Z0-9\u4e00-\u9fa5]*$"
