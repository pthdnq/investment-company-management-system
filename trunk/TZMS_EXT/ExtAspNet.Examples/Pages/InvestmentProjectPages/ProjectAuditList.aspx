<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectAuditList.aspx.cs"
    Inherits="TZMS.Web.Pages.InvestmentProjectPages.ProjectAuditList" %>
                    ...
                    <ext:Grid ID="gridData" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:LinkButtonField Hidden="true" Width="38px" Text="删除" ConfirmText="确定删除该员工?"
                                CommandName="Delete" />
                            <ext:WindowField Width="38px" Text="查看" DataIFrameUrlFields="ObjectId" DataIFrameUrlFormatString="ProjectAudit.aspx?Type=View&ID={0}"
