<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectProcessTransfer.aspx.cs" Inherits="TZMS.Web.Pages.InvestmentProjectPages.ProjectProcessTransfer" %>
                    ...
                    <ext:FormRow ColumnWidths="50% 50%">
                        <Items>
                            <ext:TextBox ID="tbAmountExpended" Enabled="false" Label="支用金额" ShowRedStar="true"
                                Required="true" runat="server" Text="0" MaxLength="16" MaxLengthMessage="最多只能输入16个数字！"
