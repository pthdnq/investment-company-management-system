...
<body>
                ...
                <Items>
                    <ext:Grid ID="gridData" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:BoundField DataField="ContractAmountEx" Width="85px" HeaderText="合同总金额" />
                            <ext:BoundField Width="80px" DataField="DownPaymentEx" HeaderText="预付定金" />
                            ...
                            <ext:WindowField Width="60px" Text="查看" DataIFrameUrlFields="ObjectId" DataIFrameUrlFormatString="ProjectApplyEditBA.aspx?Type=Edit&ID={0}"
    ...
    <ext:Window ID="wndEdit" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
        Target="Parent" runat="server" IsModal="true" Height="430px" Width="570px" OnClose="wndNew_Close">
    </ext:Window>
    <ext:Window ID="wndView" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
        Target="Parent" runat="server" IsModal="true" Height="398px" Width="550px" OnClose="wndNew_Close">
    </ext:Window>
