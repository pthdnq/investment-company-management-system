<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectAuditTransfer.aspx.cs"
    Inherits="TZMS.Web.Pages.InvestmentProjectPages.ProjectAuditTransfer" %>
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextBox Enabled="false" ID="tbContractAmount" Label="合同总金额" runat="server" MaxLength="16"
                                                MaxLengthMessage="最多只能输入16位数字！" Regex="^[0-9]*\.?[0-9]{1,2}$" RegexMessage="只能输入数字!" ShowRedStar="true"
                                                Required="true">
                                            </ext:TextBox>
                    ...
                    <ext:Tab ID="tabHistory" Title="操作历史" EnableBackgroundColor="true" runat="server"
                        ...
                        <Items>
                            <ext:Grid ID="gridHistory" Title="Grid1" ShowBorder="true" ShowHeader="false" runat="server"
                                ...
                                <Columns>
                                    <ext:BoundField Width="62px" DataField="OperationerName" HeaderText="操作人" />
