<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewMaterialsPurchase.aspx.cs"
    Inherits="TZMS.Web.NewMaterialsPurchase" %>
            ...
            <ext:Toolbar ID="Toolbar1" runat="server">
                <Items>
                    ...
                    <ext:Button ID="btnSubmit" Text="提交" Icon="Disk" runat="server" ValidateForms="pelMain"
                        OnClick="btnSubmit_Click" ConfirmText="您确定提交该申请单吗?">
                    </ext:Button>
                </Items>
            </ext:Toolbar>
        </Toolbars>
        <Items>
            <ext:Panel ID="Panel1" runat="server" ShowBorder="false" EnableBackgroundColor="true"
                                        ...
                                        <Rows>
                                            ...
                                            <ext:FormRow ID="frw2" runat="server" ColumnWidths="50% 50%">
                                                <Items>
                                                    ...
                                                    <ext:DropDownList ID="ddlstMaterialName" runat="server" Required="true" ShowRedStar="true"
                                                        Label="物资名称">
                                                    </ext:DropDownList>
                                                </Items>
                                            </ext:FormRow>
                                            <ext:FormRow ColumnWidths="50% 50%">
                                                <Items>
                                                    <ext:TextBox ID="tbxCount" runat="server" Required="true" ShowRedStar="true" Label="数量"
                                            ...
                                            <ext:FormRow ColumnWidths="50% 50%">
                                                <Items>
                                                    <ext:DatePicker ID="dpkNeedsDate" runat="server" Required="true" ShowRedStar="true"
                                                        Label="需要日期">
                                                    </ext:DatePicker>
                                            ...
                                            <ext:FormRow ColumnWidths="60%">
                                                <Items>
                                                    <ext:TextArea ID="taaSument" runat="server" Required="true" ShowRedStar="true" Label="申请事由"
                                                        Height="100px" MaxLength="500" MaxLengthMessage="最多只能输入500个字!">
                                                    </ext:TextArea>
                                                </Items>
                                            </ext:FormRow>
                                            <ext:FormRow ColumnWidths="60%">
