...
namespace TZMS.Web
{
    public partial class WorkLeaveAppNew : BasePage
    {
        /// <summary>
        /// 操作类型
        /// </summary>
        ...
        {
            ddlstLeaveType.Items.Add(new ExtAspNet.ListItem(ConvertAttedTypeToString(AttedType.TX), ((int)AttedType.TX).ToString()));
            ddlstLeaveType.SelectedIndex = 0;
        }
