...
<body>
                ...
                <Items>
                    <ext:Grid ID="gridData" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:BoundField Hidden="true"  Width="90px" DataField="Guarantee" HeaderText="担保人" />
                            <ext:BoundField Hidden="true"  Width="105px" DataField="LoanAmount" HeaderText="借款金额" />
                            <ext:BoundField Hidden="true"  Width="100px" DataField="LoanDate" DataFormatString="{0:yyyy/MM/dd}"
                                HeaderText="借款日期" />
                            <ext:BoundField Hidden="true"  Width="110px" DataField="DueDateForPay" DataFormatString="每月{0}日"
                                HeaderText="应付款日" />
                            <ext:BoundField  Hidden="true"  Width="110px" DataField="ContactPhone" HeaderText="联系电话" />
    ...
    <ext:Window ID="wndNew" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
        Target="Parent" runat="server" IsModal="true" Height="487px" Width="549px" OnClose="wndNew_Close">
    </ext:Window>
    </form>
</body>
</html>
