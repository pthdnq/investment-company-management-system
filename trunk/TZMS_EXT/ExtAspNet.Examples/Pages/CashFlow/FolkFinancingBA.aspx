<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FolkFinancingBA.aspx.cs" Inherits="TZMS.Web.Pages.CashFlow.FolkFinancingBA" %>
                        ...
                        <Items>
                            <ext:Form EnableBackgroundColor="true" LabelWidth="59px" ShowHeader="false" ShowBorder="false"
                                ...
                                <Rows>
                                    ...
                                    <ext:FormRow ColumnWidths="100%">
                                        <Items>
                                            <ext:TextArea Enabled="false"  ID="tbRemark" Label="备注" runat="server" MaxLength="50" MaxLengthMessage="最多只能输入50个字符！">
                                            </ext:TextArea>
                                        </Items>
                                    </ext:FormRow>
                                </Rows>
