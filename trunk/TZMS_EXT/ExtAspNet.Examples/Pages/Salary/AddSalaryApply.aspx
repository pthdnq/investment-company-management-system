<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSalaryApply.aspx.cs"
    Inherits="TZMS.Web.AddSalaryApply" %>
                                    ...
                                    <ext:Form EnableBackgroundColor="true" LabelWidth="85px" ShowHeader="false" ShowBorder="true"
                                        ...
                                        <Rows>
                                            ...
                                            <ext:FormRow ID="FormRow3" runat="server" ColumnWidths="60%">
                                                <Items>
                                                    <ext:Label ID="lblBaseSalary" runat="server" Label="目前基本工资">
                                                    </ext:Label>
                                                    <ext:TextBox ID="tbxExamSalary" runat="server" Label="申请加薪幅度" Regex="^[0-9]*\.?[0-9]{1,2}$"
                                                        Required="true" ShowRedStar="true" RegexMessage="金额格式不正确!" MaxLength="21" MaxLengthMessage="最多只能输入21个数字或小数点!">
                                                    </ext:TextBox>
                                                </Items>
                                            </ext:FormRow>
                                            <ext:FormRow ID="FormRow4" runat="server" ColumnWidths="60%">
                                                <Items>
                                                    <ext:TextArea ID="taaReason" runat="server" Label="加薪原因" Required="true" ShowRedStar="true"
                                                        EmptyText="请输入加薪原因" MaxLength="1000" MaxLengthMessage="最多只能输入1000个字符!" Height="200px">
                                                    </ext:TextArea>
                                                </Items>
                                            </ext:FormRow>
                                        </Rows>
