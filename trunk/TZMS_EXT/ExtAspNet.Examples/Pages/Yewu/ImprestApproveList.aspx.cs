...
namespace TZMS.Web
{
    public partial class ImprestApproveList : BasePage
    {
        ...
        private void BindGrid()
        {
            ...
            _comHelp.TableName = "ImprestApproveView";
            _comHelp.SelectList = "*";
        ...
        protected void gridApprove_RowCommand(object sender, ExtAspNet.GridCommandEventArgs e)
        {
            ...
            {
                wndApprove.IFrameUrl = "ImprestApprove.aspx?ApproveID=" + strApproveID + "&ApplyID=" + strApplyID;
