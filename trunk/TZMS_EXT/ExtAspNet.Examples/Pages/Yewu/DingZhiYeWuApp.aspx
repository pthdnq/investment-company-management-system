<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DingZhiYeWuApp.aspx.cs"
    Inherits="TZMS.Web.DingZhiYeWuApp" %>
                    ...
                    <ext:Form ID="mainForm2" EnableBackgroundColor="true" ShowHeader="false" BodyPadding="5px"
                        ...
                        <Rows>
                            ...
                            <ext:FormRow ID="FormRow3" runat="server" ColumnWidths="50% 50%">
                                <Items>
                                    <ext:TextArea ID="taaApproveSugest" Required="true" EmptyText="请说明本本业务注意细节及说明" Height="50px"
                                        runat="server" Label="提交说明" MaxLength="100" MaxLengthMessage="最多只能输入100个字！">
                                    </ext:TextArea>
                                </Items>
                            </ext:FormRow>
                        </Rows>
                                    ...
                                    <ext:Form EnableBackgroundColor="true" LabelWidth="65px" ShowHeader="false" ShowBorder="false"
                                        ...
                                        <Rows>
                                            <ext:FormRow ID="FormRow1" runat="server" ColumnWidths="60%">
                                                <Items>
                                                    <ext:DropDownList Enabled="false" ID="drpSigner" runat="server" RequiredMessage="您的“执行人”为空，请在我的首页设置我的审批人！"
                                                        Label="签单人">
                                                    </ext:DropDownList>
                                                    <ext:DatePicker ID="dpkSign" Enabled="false" Label="合同签订时间" runat="server">
                                                    </ext:DatePicker>
                                                </Items>
                                            </ext:FormRow>
                                            <ext:FormRow ID="FormRow7" runat="server" ColumnWidths="60%">
                                                <Items>
                                                    <ext:TextBox ID="tbxTitle" runat="server" Enabled="false" Label="业务标题" MaxLength="100"
                                            ...
                                            <ext:FormRow ID="FormRow8" runat="server" ColumnWidths="60%">
                                                <Items>
                                                    <ext:TextArea ID="taaSument" Enabled="false" runat="server" Label="内容" MaxLength="1000"
                                                        MaxLengthMessage="最多只能输入1000个字！" Height="100px">
                                                    </ext:TextArea>
                                                </Items>
                                            </ext:FormRow>
                                            <ext:FormRow ID="FormRow6" runat="server">
                                                <Items>
                                                    <ext:TextArea ID="taaOther" Enabled="false" runat="server" Label="操作记录" Height="200px">
                                                    </ext:TextArea>
                                                </Items>
                                            </ext:FormRow>
                                        </Rows>
