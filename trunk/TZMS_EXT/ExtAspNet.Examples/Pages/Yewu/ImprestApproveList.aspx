<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImprestApproveList.aspx.cs" Inherits="TZMS.Web.ImprestApproveList" %>
...
<ext:PageManager ID="PageManager1" AutoSizePanelID="pelMain" HideScrollbar="true"
                ...
                <Items>
                    <ext:Grid ID="gridApprove" Title="Grid1" ShowBorder="true" ShowHeader="false"
                        ...
                        <Columns>
                            ...
                            <ext:BoundField DataField="Title" HeaderText="项目标题" DataTooltipField="Title" />
    ...
    <ext:Window ID="wndApprove" Title="备用金审批" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
