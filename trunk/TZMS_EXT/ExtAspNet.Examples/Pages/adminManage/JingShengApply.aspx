<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JingShengApply.aspx.cs"
    Inherits="TZMS.Web.JingShengApply" %>
                                    ...
                                    <ext:Form EnableBackgroundColor="true" LabelWidth="85px" ShowHeader="false" ShowBorder="true"
                                        ...
                                        <Rows>
                                            ...
                                            <ext:FormRow ID="FormRow3" runat="server" ColumnWidths="60%">
                                                <Items>
                                                    <ext:Label ID="lblPosition" runat="server" Label="目前职位">
                                                    </ext:Label>
                                                    <ext:TextBox ID="tbxApplyPosition" runat="server" Label="申请职位" Required="true" ShowRedStar="true"
                                            ...
                                            <ext:FormRow ID="FormRow4" runat="server" ColumnWidths="60%">
                                                <Items>
                                                    <ext:TextArea ID="taaReason" runat="server" Label="晋升调岗原因" Required="true" ShowRedStar="true"
                                                        EmptyText="请输入晋升调岗原因" MaxLength="1000" MaxLengthMessage="最多只能输入1000个字符!" Height="200px">
                                                    </ext:TextArea>
                                                </Items>
                                            </ext:FormRow>
                                        </Rows>
