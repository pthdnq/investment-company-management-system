<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JingShengToFile.aspx.cs"
    Inherits="TZMS.Web.JingShengToFile" %>
...
<body>
    ...
    <ext:Panel ID="pelMain" runat="server" EnableBackgroundColor="true" BodyPadding="3px"
                ...
                <Items>
                    <ext:Grid ID="gridArchiver" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:BoundField HeaderText="部门" />
                            <ext:BoundField HeaderText="目前职位" />
                            <ext:BoundField HeaderText="申请职位" />
                            <ext:BoundField HeaderText="晋升调岗原因" ExpandUnusedSpace="true" />
        ...
        <ext:Window ID="wndApprove" Title="晋升调岗审批" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
