<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecruitmentToFile.aspx.cs" Inherits="TZMS.Web.RecruitmentToFile" %>
...
<body>
    ...
    <ext:Panel ID="pelMain" runat="server" EnableBackgroundColor="true" BodyPadding="3px"
                ...
                <Items>
                    <ext:Grid ID="gridArchiver" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:BoundField HeaderText="标题" />
                            <ext:BoundField HeaderText="内容" ExpandUnusedSpace="true" />
        ...
        <ext:Window ID="wndApprove" Title="招聘申请归档" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
