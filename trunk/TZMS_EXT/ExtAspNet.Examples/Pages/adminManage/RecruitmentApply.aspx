<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecruitmentApply.aspx.cs" Inherits="TZMS.Web.RecruitmentApply" %>
            ...
            <ext:Panel ID="pelOperator" runat="server" ShowBorder="false" EnableBackgroundColor="true"
                ...
                <Items>
                    ...
                    <ext:TabStrip ID="TabStrip1" runat="server" ActiveTabIndex="0" ShowBorder="false"
                        ...
                        <Tabs>
                            <ext:Tab ID="Tab1" Title="招聘申请单" EnableBackgroundColor="true" runat="server" BodyPadding="5px">
                                <Items>
                                            ...
                                            <ext:FormRow ID="FormRow3" runat="server" ColumnWidths="60%">
                                                <Items>
                                                    <ext:TextBox ID="tbxTitle" runat="server" Label="标题" Required="true" ShowRedStar="true"
                                                        EmptyText="请输入招聘标题" MaxLength="100" MaxLengthMessage="最多只能输入100个字符!">
                                                    </ext:TextBox>
                                                </Items>
                                            </ext:FormRow>
                                            <ext:FormRow ID="FormRow4" runat="server" ColumnWidths="60%">
                                                <Items>
                                                    <ext:TextArea ID="taaContent" runat="server" Label="内容" Required="true" ShowRedStar="true"
                                                        EmptyText="请输入招聘内容" MaxLength="1000" MaxLengthMessage="最多只能输入1000个字符!" Height="250px">
                                                    </ext:TextArea>
                                                </Items>
                                            </ext:FormRow>
                                        </Rows>
