<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLeaveTransferToFile.aspx.cs"
    Inherits="TZMS.Web.UserLeaveTransferToFile" %>
            ...
            <ext:Panel ID="pelGrid" ShowBorder="True" ShowHeader="false" AnchorValue="100% -36"
                ...
                <Items>
                    <ext:Grid ID="gridArchiver" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            <ext:BoundField HeaderText="ObjectID" Hidden="true" />
