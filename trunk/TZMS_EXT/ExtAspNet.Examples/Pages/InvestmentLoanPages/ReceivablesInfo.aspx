            ...
            <ext:Form EnableBackgroundColor="true" ShowHeader="false" BodyPadding="5px" ID="mainFrame"
                runat="server">
                 ...
                 <ext:FormRow ColumnWidths="50% 50%">
                    ...
                    <ext:FormRow ColumnWidths="50% 50%">
                        <Items>
                            <ext:DatePicker Enabled="false"  ID="dpDueDateForReceivables" Label="应收借款日" ShowRedStar="true" Required="true"
                                runat="server">
                            </ext:DatePicker>
                    ...
                    <ext:FormRow ColumnWidths="100%">
                        <Items>
                            <ext:TextBox Enabled="false"  ID="tbReceivablesAccount" Label="收款帐号或现金" runat="server" MaxLength="50" MaxLengthMessage="最多只能输入50个字符！"
                    ...
                    <ext:FormRow ColumnWidths="50% 50%">
                        <Items>
                            <ext:TextArea Enabled="false" ID="taRemark" Label="备注" runat="server" Regex="^[a-zA-Z0-9\u4e00-\u9fa5]*$" RegexMessage="不能输入特殊字符!"
                                ...
                                <ext:FormRow ColumnWidths="50% 50%">
                        <Items>
                            <ext:TextArea Enabled="false" ID="taAuditOpinionRemark" Label="支付备注" runat="server" Regex="^[a-zA-Z0-9\u4e00-\u9fa5]*$" RegexMessage="不能输入特殊字符!"
                                MaxLength="200" MaxLengthMessage="最多只能输入200个字符！" />
                        </Items>
                    </ext:FormRow>
                </Rows>
