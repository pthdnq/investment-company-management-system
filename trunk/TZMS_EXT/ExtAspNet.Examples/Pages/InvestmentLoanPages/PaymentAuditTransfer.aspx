<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentAuditTransfer.aspx.cs" Inherits="TZMS.Web.Pages.InvestmentLoanPages.PaymentAuditTransfer" %>
                        ...
                        <Items>
                            <ext:Form EnableBackgroundColor="true" LabelWidth="55px" ShowHeader="false" ShowBorder="false"
                                ...
                                <Rows>
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextBox ID="tbBorrowerNameA" Enabled="false" Label="借款人(甲方)" runat="server" MaxLength="20"
