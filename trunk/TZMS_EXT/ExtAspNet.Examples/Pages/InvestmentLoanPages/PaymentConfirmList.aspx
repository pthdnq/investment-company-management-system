<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentConfirmList.aspx.cs"
    Inherits="TZMS.Web.Pages.InvestmentLoanPages.PaymentConfirmList" %>
...
<body>
                ...
                <Items>
                    <ext:Grid ID="gridData" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:BoundField Width="115px" DataField="LoanDate" DataFormatString="{0:yyyy/MM/dd}" HeaderText="借款日期" />
                            <ext:BoundField DataField="DueDateForPay" Width="65px" HeaderText="应付借款日" />
                            <ext:BoundField Width="110px"  DataField="SubmitTime"  HeaderText="提交时间"/>
    ...
    <ext:Window ID="wndNew" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
        Target="Parent" runat="server" IsModal="true" Height="664px" Width="580px" OnClose="wndNew_Close">
    </ext:Window>
    </form>
</body>
</html>
