<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPaymentConfirmList.aspx.cs" Inherits="TZMS.Web.Pages.AdminExpensesManage.AdminPaymentConfirmList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>AdminPaymentConfirmList</title>
</head>
<body>
        ...
        <Items>
            ...
            <ext:Panel ID="pelGrid" ShowBorder="True" ShowHeader="false" AnchorValue="100% -54"
                ...
                <ext:TemplateField Width="66px" HeaderText="付款方式">
                            ...
                            <ext:WindowField Width="38px" Text="查看" DataIFrameUrlFields="ObjectId" DataIFrameUrlFormatString="AdminPaymentConfirm.aspx?Type=View&ID={0}"
                                Title="查看" WindowID="wndView" />
                            <ext:WindowField Width="38px" Text="确认" DataIFrameUrlFields="ObjectId" DataIFrameUrlFormatString="AdminPaymentConfirm.aspx?Type=Confirm&ID={0}"
                                Title="确认" WindowID="wndEdit" />
...
<%--    <ext:Window ID="wndNew" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
    ...
    <ext:Window ID="wndView" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
        Target="Parent" runat="server" IsModal="true" Height="359px" Width="550px" OnClose="wndNew_Close">
    </ext:Window>
