<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPaymentConfirm.aspx.cs" Inherits="TZMS.Web.Pages.AdminExpensesManage.AdminPaymentConfirm" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>AdminPaymentConfirm</title>
</head>
<body>
    ...
    <ext:Panel ID="pelMain" runat="server" EnableBackgroundColor="true" BodyPadding="3px"
            ...
            <ext:Toolbar ID="Toolbar1" runat="server">
                <Items>
                    ...
                    <ext:Button ID="btnSave" runat="server" ValidateForms="mainFrame" OnClick="btnSave_Click"
                        IconUrl="~/Images/ico_nextstep.gif" Text="确认" ConfirmText="您要确认该申请吗?" />
        ...
        <Items>
            <ext:Form EnableBackgroundColor="true" ShowHeader="false" BodyPadding="5px" ID="mainFrame"
                runat="server">
                <Rows>
                    <ext:FormRow Hidden="true" ID="FormRow2" runat="server" ColumnWidths="50% 50%">
                        <Items>
                            <ext:DropDownList   ID="ddlstNext" runat="server"
                                Label="下一步"  Hidden="true" OnSelectedIndexChanged="ddlstNext_SelectedIndexChanged">
                            </ext:DropDownList>
                            <ext:DropDownList  Hidden="true"  ID="ddlstApproveUser" runat="server"
                            ...
                            <ext:Form EnableBackgroundColor="true" LabelWidth="63px" ShowHeader="false" ShowBorder="false"
                                ...
                                <Rows>
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        ...
                                        <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextBox ID="tbCompany" Enabled="false" Label="单位" runat="server" MaxLength="20"
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            ...
                                            <ext:TextBox ID="tbAmountOfPayment" Enabled="false" Label="金额" runat="server" MaxLength="8"
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextArea ID="taCause" Enabled="false" Label="付款事由" runat="server" MaxLength="200"
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:DropDownList runat="server" Enabled="false" Label="付款方式" ID="ddlPaymentType">
