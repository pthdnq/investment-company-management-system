<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminImprestConfirm.aspx.cs"
    Inherits="TZMS.Web.Pages.AdminExpensesManage.AdminImprestConfirm" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>AdminImprestConfirm</title>
</head>
<body>
                        ...
                        <Items>
                            <ext:Form EnableBackgroundColor="true" LabelWidth="63px" ShowHeader="false" ShowBorder="false"
                                ...
                                <Rows>
                                  ...
                                  <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextBox ID="tbPrepaidAmount" Enabled="false" Label="预支金额" runat="server" MaxLength="8"
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextArea ID="taUse" Enabled="false" Label="用途" runat="server" MaxLength="200"
