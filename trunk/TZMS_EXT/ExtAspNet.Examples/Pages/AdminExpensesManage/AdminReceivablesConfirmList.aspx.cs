...
{
    public partial class AdminReceivablesConfirmList : BasePage
    {
        #region 属性viewstate
        /// <summary>
        /// 用于存储 状态的ViewState.
        ...
        private void BindGridData(string state, string searchText)
        {
            ...
            //获得 list
            List<AdminReceivablesInfo> lstUserInfo = new AdminReceivablesManage().GetUsersByCondtion(strCondtion.ToString());
        ...
        protected void gridData_RowDataBound(object sender, GridRowEventArgs e)
        {
            ...
            if (!_userInfo.NextOperaterId.Equals(this.CurrentUser.ObjectId) || !this.ddlstState.SelectedValue.Equals("4"))
            {
