<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPaymentConfirmPrinter.aspx.cs"
    Inherits="TZMS.Web.Pages.AdminExpensesManage.AdminPaymentConfirmPrinter" %>
...
<body>
    ...
    <div style="width: 800px;">
        ...
        <table class="jxtable" border="1" cellpadding="10" cellspacing="0">
            ...
            <tr>
                <td colspan="2">
                    事由： <asp:Label runat="server" ID="lbCause"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="2">
