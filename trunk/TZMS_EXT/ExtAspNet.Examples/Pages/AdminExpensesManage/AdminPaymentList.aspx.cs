...
{
    public partial class AdminPaymentList : BasePage
    {
        #region viewstate
        /// <summary>
        /// 用于存储状态的ViewState.
        ...
        {
            AdminImprestManage userManage = new AdminImprestManage();
            string iiD = ((GridRow)gridData.Rows[e.RowIndex]).Values[0];

            AdminImprestInfo info = userManage.GetUserByObjectID(iiD);
