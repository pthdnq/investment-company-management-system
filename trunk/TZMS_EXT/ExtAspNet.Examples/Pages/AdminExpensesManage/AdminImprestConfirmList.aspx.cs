...
{
    public partial class AdminImprestConfirmList : BasePage
    {
        #region 属性viewstate
        /// <summary>
        /// 用于存储 状态的ViewState.
        ...
        private void BindGridData(string state, string searchText)
        {
            ...
            //获得 list
            List<AdminImprestInfo> lstUserInfo = new AdminImprestManage().GetUsersByCondtion(strCondtion.ToString());
        ...
        {
            AdminImprestInfo _userInfo = (AdminImprestInfo)e.DataItem;
