...
{
    public partial class AdminImprestConfirm : BasePage
    {
        #region 属性
        ...
        private void InitControl()
        {
            ...
            hlPrinter.NavigateUrl = "AdminImprestConfirmPrinter.aspx?ID=" + ObjectID;
        }
        ...
        private void saveInfo(int status)
        {
            ...
            if (result == -1)
            {
                ...
                //提醒申请人，会计确认
                ResultMsgMore(_Info.CreaterId.ToString(), _Info.CreaterName, "您有1条备用金申请（来自费用管理），出纳已确认！");
                //Alert.Show("操作成功!");
