<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaderAuditResult.aspx.cs" Inherits="TZMS.Web.Pages.FolkFinancingPages.LeaderAuditResult" %>
                ...
                <Items>
                    <ext:Grid ID="gridData" Title="Grid1" ShowBorder="true" ShowHeader="false" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:WindowField Width="38px" Text="审核" DataIFrameUrlFields="ObjectId" DataIFrameUrlFormatString="LeaderAuditResultView.aspx?Type=Edit&ID={0}"
