                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextBox ID="tbGuarantee" Label="担保人" ShowRedStar="true" Required="true" runat="server"
                                                ...
                                                MaxLength="20" MaxLengthMessage="最多只能输入20个数字！" Regex="^[0-9]*$" RegexMessage="只能输入数字!"     AutoPostBack="true" OnTextChanged="tbCash_OnTextChanged" CompareControl="tbLoanAmount"
