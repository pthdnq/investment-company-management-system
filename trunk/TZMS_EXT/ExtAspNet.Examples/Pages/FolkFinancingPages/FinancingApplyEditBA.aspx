<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinancingApplyEditBA.aspx.cs"
    Inherits="TZMS.Web.Pages.FolkFinancingPages.FinancingApplyEditBA" %>
                                ...
                                <Rows>
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            ...
                                            <ext:TextBox Enabled="false" ID="tbLenders" Label="出款人" runat="server" MaxLength="20"
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:DatePicker Hidden="true" Enabled="false" ID="dpLoanDate" Label="借款日期" runat="server">
                                            </ext:DatePicker>
                                            <ext:TextBox Hidden="true" Enabled="false" ID="dpDueDateForPay" Label="应付款日" runat="server"
