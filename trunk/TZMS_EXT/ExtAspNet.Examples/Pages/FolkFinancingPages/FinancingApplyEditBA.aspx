<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinancingApplyEditBA.aspx.cs" Inherits="TZMS.Web.Pages.FolkFinancingPages.FinancingApplyEditBA" %>
                    ...
                    <ext:FormRow ID="FormRow2" runat="server" ColumnWidths="50% 50%">
                        <Items>
                          ...
                          <ext:FormRow ColumnWidths="100%">
                                        <Items>
                                            <ext:TextArea  ID="tbRemark" Label="备注(需提供的材料)" runat="server" MaxLength="200" MaxLengthMessage="最多只能输入200个字符！">
                                            </ext:TextArea>
                                        </Items>
                                    </ext:FormRow>
                    <ext:FormRow ColumnWidths="100%">
                        <Items>
                            <ext:TextArea ID="taAuditOpinion" Enabled="false"  Label="审核备注" runat="server" MaxLength="200" MaxLengthMessage="最多只能输入200个字符！"
                            ...
                            <ext:Form EnableBackgroundColor="true" LabelWidth="59px" ShowHeader="false" ShowBorder="false"
                                ...
                                <Rows>
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextBox Enabled="false" ID="tbBorrowerNameA" Label="借款人"  
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextBox Enabled="false"  ID="tbGuarantee" Label="担保人"  runat="server"
                                                MaxLength="20" MaxLengthMessage="最多只能输入20个字符！" Regex="^[a-zA-Z0-9\u4e00-\u9fa5]*$"
                                                RegexMessage="不能输入特殊字符!">
                                            </ext:TextBox>
                                        </Items>
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            ...
                                            <ext:TextBox Enabled="false"  ID="dpDueDateForPay" Label="应付款日"  
                                    ...
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextBox Enabled="false"  ID="tbCollateral" Label="抵押物" runat="server" MaxLength="20" MaxLengthMessage="最多只能输入20个字符！">
                                            </ext:TextBox>
                                        </Items>
                                    </ext:FormRow>
                                    <ext:FormRow ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:TextBox  Enabled="false" ID="tbBorrowingCost" Label="借款成本" 
