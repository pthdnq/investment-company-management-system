    ...
    public class WuZhiRecordCtrl
    {
        ...
        public int Insert(string boName, WuZhiRecordInfo WuZhiRecordInfo)
        {
            try
            {
                ...
                new SqlParameter("@RecordTime",DbType.DateTime)
				};
                ...
                sqlparam[i++].Value = WuZhiRecordInfo.RecordTime;
        ...
        internal WuZhiRecordInfo WuZhiRecordInfoRowToInfo(DataRow InfoDataRow)
        {
            ...
            if (InfoDataRow["RecordTime"] != null)
            {
                Info.RecordTime = DateTime.Parse(DataUtil.GetStringValueOfRow(InfoDataRow, "RecordTime"));
            }
