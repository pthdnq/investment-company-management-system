//----------------------------------------------------------------------------------------------------
//程序名:	RecruitmentApprove实体类
//功能:   定义了与 dbo.RecruitmentApprove 表 对应的数据实体类
//作者:  	xiguazerg
//时间:	2010-10-25 
//----------------------------------------------------------------------------------------------------
//更改历史:
...
{
    /// <summary>
    /// RecruitmentApprove实体类
    /// </summary>
    [Serializable]
    public class RecruitmentApproveInfo : ACommonInfo
    {
