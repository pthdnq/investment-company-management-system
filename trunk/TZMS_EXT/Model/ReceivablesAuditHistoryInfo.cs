//----------------------------------------------------------------------------------------------------
//程序名:	ReceivablesAuditHistory实体类
//功能:   定义了与 dbo.ReceivablesAuditHistory 表 对应的数据实体类
//作者:  	CodeSmith
//时间:	2010-10-25 
//----------------------------------------------------------------------------------------------------
//更改历史:
...
{
    /// <summary>
    /// ReceivablesAuditHistory实体类
    /// </summary>
    [Serializable]
    public class ReceivablesAuditHistoryInfo : ACommonInfo
    {
        ...
        /// Constructor
        /// </summary>
        public ReceivablesAuditHistoryInfo()
        {
            //todo
        }
        #endregion
