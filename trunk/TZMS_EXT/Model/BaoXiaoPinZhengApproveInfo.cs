//----------------------------------------------------------------------------------------------------
//程序名:	BaoXiaoPinZhengApprove实体类
//功能:   定义了与 dbo.BaoXiaoPinZhengApprove 表 对应的数据实体类
//作者:  	xiguazerg
//时间:	2010-10-25 
//----------------------------------------------------------------------------------------------------
//更改历史:
...
{
    /// <summary>
    /// BaoXiaoPinZhengApprove实体类
    /// </summary>
    [Serializable]
    public class BaoXiaoPinZhengApproveInfo : ACommonInfo
    {
        ...
        /// Constructor
        /// </summary>
        public BaoXiaoPinZhengApproveInfo()
        {
            //todo
        }
        #endregion
