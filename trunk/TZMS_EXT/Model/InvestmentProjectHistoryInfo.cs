//----------------------------------------------------------------------------------------------------
//程序名:	InvestmentProjectHistory实体类
//功能:   定义了与 dbo.InvestmentProjectHistory 表 对应的数据实体类
//作者:  	CodeSmith
//时间:	2010-10-25 
//----------------------------------------------------------------------------------------------------
//更改历史:
...
{
    /// <summary>
    /// InvestmentProjectHistory实体类
    /// </summary>
    [Serializable]
    public class InvestmentProjectHistoryInfo : ACommonInfo
    {
        ...
        /// Constructor
        /// </summary>
        public InvestmentProjectHistoryInfo()
        {
            //todo
        }
        #endregion
