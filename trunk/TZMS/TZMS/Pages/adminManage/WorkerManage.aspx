...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function formatter(data, index) {
            return "<a href='#'>离职</a>&nbsp;&nbsp;<a href='#'>编辑</a>&nbsp;&nbsp;<a href='#'>权限</a>&nbsp;&nbsp;<a href='#'>删除</a>";
        }
        ...
        function search() {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $('#grvUsers').grid({  gridline: 'all', pageMode: "local", pageSize: 15, pageList: [10, 15, 20], rownumbers: true, columns:
                    [
                        [
                            { title: "工号", field: "JobNo",width: "60px", align: "center" },
                            { title: "姓名", field: "Name", width: "80px", align: "center" },
                            { title: "账号", field: "AccountNo", width: "60px", align: "center" },
                            { title: "性别", field: "Sex", width: "40px", align: "center" },
                            { title: "部门", field: "Dept", width: "80px", align: "center" },
                            { title: "联系电话", field: "PhoneNumber", width: "150px", align: "center" },
                            { title: "员工状态", field: "State", width: "100px", align: "center" },
                            { title: "操作",  formatter: formatter, align: "center" }
                        ]
                    ]
                    }).bind("");
